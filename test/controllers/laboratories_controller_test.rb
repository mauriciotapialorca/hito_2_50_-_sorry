...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference("Laboratory.count") do
      post laboratories_url, params: { laboratory: { description: @laboratory.description, number_laboratory: @laboratory.number_laboratory } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { description: @laboratory.description, number_laboratory: @laboratory.number_laboratory } }
